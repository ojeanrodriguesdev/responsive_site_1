    ...
    <div className='container mx-auto border-b py-6 pb-10'>
        ...
        <div className="flex flex-wrap items-center">
            {FEATURED_PROPERTIES.map((property, index) => (
                <div key={index} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 items-center">
                    <Link href='#' className="m-2 inline-block"/>
                    <div className="flex flex-col items-center">
                        <Image className="mb-8 rounded-lg object-cover justify-center" src={property.image} width={300} height={300} alt={property.name}/>
